...
grep --no-group-separator -A1 'complete genome' ../data/all_complete_refseq_bac_oneline.fasta | \
...
grep --no-group-separator -A1 'Streptococcus' ../data/all_complete_refseq_bac_oneline.fasta > ../data/subset_Streptococcus.fasta
